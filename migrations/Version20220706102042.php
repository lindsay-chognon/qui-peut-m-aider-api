 ...
 */
final class Version20220706102042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE disponibilites (id INT AUTO_INCREMENT NOT NULL, prestation_id INT NOT NULL, debut TIME NOT NULL, fin TIME NOT NULL, INDEX IDX_B0F3489C9E45C554 (prestation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jour (id INT AUTO_INCREMENT NOT NULL, prestation_id INT NOT NULL, jour DATE NOT NULL, INDEX IDX_DA17D9C59E45C554 (prestation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
